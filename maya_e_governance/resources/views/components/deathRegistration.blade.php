        ...
        <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div class="pt-4 pb-2">
                <h5 class="card-title text-center pb-0 fs-4">Death Registration Form</h5>
                <!-- <p class="text-center small">Enter your personal details to create account</p> -->
              </div>

              <form class="row g-3 needs-validation" novalidate>
                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Deceaced Name</label>
                ...
                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Place/Country of Death</label>
                  <input type="text" name="name" class="form-control" id="yourName" required>
                  <div class="invalid-feedback">Please, enter the Place/Country of Birth!</div>
                </div>

                <div class="col-lg-6 col-12">
                  <label for="dateOfBirth" class="form-label">Date of Death</label>
                  <input type="date" name="dateOfBirth" id="dateOfBirth" class="form-control" required>
                  <div class="invalid-feedback">Please, select the date of death!</div>
                </div>
