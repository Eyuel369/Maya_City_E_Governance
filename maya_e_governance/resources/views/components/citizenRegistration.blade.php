        ...
        <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div class="pt-4 pb-2">
                <h5 class="card-title text-center pb-0 fs-4">Citizen Registration Form</h5>
              ...
              <form class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-lg-6 col-12">
                    <label for="wifePicture" class="form-label">Your Picture</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="wifePicture" aria-describedby="wifePictureHelp" required>
                      <label for="wifePicture" class="custom-file-label">Choose file...</label>
                      <small id="wifePictureHelp" class="form-text text-muted">Please upload your picture.</small>
                    </div>
                ...
                <div class="col-lg-6 col-12">
                  ...
                  <small id="phoneHelp" class="form-text text-muted">Your login info will be sent using this phone.</small>
                </div>
                ...
                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Mother's Full name</label>
                  <input type="text" name="name" class="form-control" id="yourName" required>
                  <div class="invalid-feedback">Please, enter the Mother's Full name!</div>
                </div>

                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Mother's Nationality</label>
                  <input type="text" name="name" class="form-control" id="yourName" required>
                  <div class="invalid-feedback">Please, enter the Mother's Nationality!</div>
                </div>

                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Father's Full Name</label>
                  <input type="text" name="name" class="form-control" id="yourName" required>
                  <div class="invalid-feedback">Please, enter the Father's Full Name!</div>
                </div>

                <div class="col-lg-6 col-12">
                  <label for="yourName" class="form-label">Father's Nationality</label>
                  <input type="text" name="name" class="form-control" id="yourName" required>
                  <div class="invalid-feedback">Please, enter the Father's Nationality!</div>
                </div>
